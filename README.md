...
![config file screenshot](http://i.imgur.com/dubEjtc.png)
  ...
  * `darktheme` By default set to false. Use the **Dark mode** checkbox at the bottom right of the main window to switch instantly; the choice is saved automatically. If set true dark theme is used for the applications interface, as defined in the qdarkstylesheet.qss, also resource_file.py contains icons for dark theme
